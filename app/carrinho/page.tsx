...
const shippingOptions: ShippingOption[] = [
  ...
  { id: "sedex", name: "SEDEX", price: 28.9, days: "2-3 dias úteis" },
  { id: "express", name: "Entrega Expressa", price: 45.9, days: "1-2 dias úteis" },
]
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <CardContent className="p-3 sm:p-4 md:p-6">
                  <div className="flex gap-3 sm:gap-4">
                    ...
                    <Link
                      ...
                      className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 flex-shrink-0 rounded-lg overflow-hidden bg-muted"
                    >
                      <Image
                    ...
                    <div className="flex-1 min-w-0">
                      <Link href={`/produto/${item.product.slug}`}>
                        <h3 className="font-medium text-card-foreground hover:text-primary transition-colors line-clamp-2 text-sm sm:text-base">
                          {item.product.name}
                        </h3>
                      </Link>
                      <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">{item.product.brand}</p>
          ...
          <div className="space-y-3 sm:space-y-4 order-1 lg:order-2">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="p-3 sm:p-4 md:p-6 pt-0 space-y-3 sm:space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm sm:text-base text-card-foreground">
                    <span>Subtotal</span>
                  ...
                  <div className="flex justify-between text-sm sm:text-base text-card-foreground">
                    <span>Frete</span>
                    <span className={shipping?.price === 0 ? "text-green-600 font-semibold" : ""}>
